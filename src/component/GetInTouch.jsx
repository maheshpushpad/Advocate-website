  ...
  return (
    <section className="bg-slate-100 py-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold border-2 mx-auto bg-white w-[60%] border-black rounded-xl p-2 text-black">Get In Touch with Binary Associates</h2>
      </div>
      <div className="flex flex-wrap justify-center items-center gap-8">
        <ContactItem
          ...
          text={
            <>
            <a href="tel:8982324143">+91 8982324143</a>
            <br/>
            <a href="tel:9617189757">+91 9617189757</a>
            </>
          }
        />
        <ContactItem
          ...
          text={
          <>
          <a href="mailto:Binary@gmail.com">Binary@gmail.com</a>
          <br/>
          <a href="mailto:Binary@gmail.com">Binary@gmail.com</a>
          </>}
        />
        ...
        <ContactItem
          ...
          text={
            <>
              <p>105 Ayodhya Nagar, Amrit Enclave, Bhopal</p>
            </>
          }
        />
      </div>
...
const ContactItem = ({ icon, title, text }) => {
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 hover:scale-105 transition text-center w-72">
      <div className="bg-black w-20 h-20 rounded-full flex items-center hover:scale-90 transition justify-center mx-auto mb-4">
        {icon}
      </div>
